...
Generated: `2026-08-14T14:22:47+00:00`
...
| G2 — Reproducible pilot proven | 0.5.0 | blocked_by_maturity | no | not_evaluated | 6/13 | required work not accepted: WI-G2-01; required work not accepted: WI-G2-02; required work not accepted: WI-G2-03; +11 more |
...
|---|---:|---:|---:|---:|
| T0 — Governance, ethics and independence | 11/11 (100.0%) | 3/11 (27.3%) | 0 | 4/19 |
...
- **P1 WI-G2-02** (T3/G2): Representative API, spreadsheet, HTML/dashboard and PDF/manual acquisition paths have reproducible manifests. — _done_
...
- **P1 WI-G2-04** (T5/G2): Pilot extractions and mappings have documented dual review, adjudication and quarantine outcomes. — _done_
