...
3. Extend the verified SWE empirical replay where the remaining source routes
   have usable contracts, and finish product/browser and operational evidence.
4. Reconcile the hosted inventory's policy claims with canonical owner records,
   qualify products, and resolve public Explorer and registry readiness.
...
- `docs/governance/g2-l2-fresh-local-checks-2026-09-05.json`:
  matching product builds and local copy verification; 23 jurisdictions and
  245 search records checked, including 171 draft and 168 inaccessible rows.
- `docs/engineering/hosted-estate-observation-2026-09-05.json`:
  current public dataset availability and specific hosted gaps.

The September 3 missing-byte receipt remains historical evidence; it no longer
