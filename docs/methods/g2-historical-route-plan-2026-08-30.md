...
The current future-edition monitors and all terminal records remain unchanged.

The recommended route removes a calendar wait only if later authorized and if
