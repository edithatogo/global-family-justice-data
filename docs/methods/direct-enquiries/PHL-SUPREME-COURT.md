...
sent message, delivery evidence, and any official acknowledgement or reference.

## Why an enquiry remains required

The annual material is an official institutional source, but the repository's
assessment remains partial. It does not establish consistent family-case
