...
| R12 | Pipeline depends on one engineer/researcher | High | High | Owner-unavailable pause, analyst-agent operational continuity, runbooks, tests, clean build and handover exercises; no substitute approval | Single approver/maintainer; owner unavailability pauses governed decisions and release | T0/T4/T8/T9 |
