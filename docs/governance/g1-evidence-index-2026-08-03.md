...
| G1-C06 / WI-G1-06 Risk, threat, rights, disclosure baseline | E-RISK-REGISTER — `docs/programme/risk-register.md`; E-THREAT-BASELINE — `docs/security/threat-model.md`; E-RIGHTS-BASELINE — `docs/security/rights-and-redistribution.md` | `619a8e1750e5a18c0a5773eae038ff5f06f86429fba50eff3cebde8e5464f3ff`; `23e7c04db906497bb9672d4902af7d4022495db31bcb14cfc82fc96f36c88812`; `2f41db254e1ff995a7eace4a28f3d218058c0866051fadbe71a16cfdfbb5a722` | Security/data-governance owner / in_review or draft | Specialist rights, legal, privacy and security review; residual-risk adjudication |
