...
- [~] Record the actual owner authorization in a signed commit, binding bundle
  SHA-256 `e166ea3785521bdcf1802bdc005383af40f054a1c349871d313c91e963107004`.
- [ ] Delegate the frozen one-shot CLI to a fresh metadata registrar; preserve
  the unmodified receipt and attempt marker. No result URLs or sources opened.
- [ ] Separate network-prohibited advisory review of the receipt, scope,
