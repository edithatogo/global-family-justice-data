...
## 1. Why a maturity model is needed

A large international data project can appear mature because it has many rows, a polished dashboard or prestigious partners. Those are weak proxies. Maturity is demonstrated only when governance, methods, evidence, software, security and operations progress together.

A capability is assigned the lowest level for which all required evidence exists. The overall project level is the lowest level across the mandatory dimensions; strengths in one dimension do not offset a critical weakness in another.

## 2. Levels

| Level | Name | Meaning |
|---|---|---|
| M0 | Concept | Problem and ambition are described, but scope and ownership remain provisional |
...
Maturity claims require artefacts, not intentions. Acceptable evidence includes:

- approved and dated decision records;
- versioned schemas and methods;
- CI logs and deterministic build outputs;
- completed review ledgers and audit samples;
